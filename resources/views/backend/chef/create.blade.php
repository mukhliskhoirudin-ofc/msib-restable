    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-lg-12 mb-4 order-0">
                ...
                <div class="card">
                    <h5 class="card-header">Create chef</h5>
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select name="position" class="form-select @error('position') is-invalid @enderror"
                                        ...
                                        <option value="master chef" @selected(old('position') == 'master chef')>Master
                                            Chef
                                        </option>
                                        <option value="patissier" @selected(old('position') == 'patissier')>
                                            Patissier
                                        </option>
                                        <option value="cook" @selected(old('position') == 'cook')>
                                            Cook
                                        </option>
                                    </select>
                                    @error('position')
